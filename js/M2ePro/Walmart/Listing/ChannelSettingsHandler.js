WalmartListingChannelSettingsHandler = Class.create();
WalmartListingChannelSettingsHandler.prototype = Object.extend(new CommonHandler(), {
    ...
    initialize: function()
    {
        Validation.add('M2ePro-validate-condition-note-length', M2ePro.text.condition_note_length_error, function(value) {
            ...
            if ($('condition_note_mode').value != WalmartListingChannelSettingsHandlerObj.CONDITION_NOTE_MODE_CUSTOM_VALUE) {
                return true;
            }
        ...
        Validation.add('M2ePro-validate-sku-modification-custom-value', M2ePro.text.sku_modification_custom_value_error, function(value) {
            ...
            var self = WalmartListingChannelSettingsHandlerObj;
        ...
        Validation.add('M2ePro-validate-sku-modification-custom-value-max-length', M2ePro.text.sku_modification_custom_value_max_length_error, function(value) {
            ...
            return value.length < M2ePro.php.constant('Ess_M2ePro_Helper_Component_Walmart::SKU_MAX_LENGTH');
        });
    },
    ...
    {
        return [
            M2ePro.php.constant('Ess_M2ePro_Model_Walmart_Listing::CONDITION_USED_LIKE_NEW'),
            M2ePro.php.constant('Ess_M2ePro_Model_Walmart_Listing::CONDITION_USED_VERY_GOOD'),
            M2ePro.php.constant('Ess_M2ePro_Model_Walmart_Listing::CONDITION_USED_GOOD'),
            M2ePro.php.constant('Ess_M2ePro_Model_Walmart_Listing::CONDITION_USED_ACCEPTABLE'),
            M2ePro.php.constant('Ess_M2ePro_Model_Walmart_Listing::CONDITION_COLLECTIBLE_LIKE_NEW'),
            M2ePro.php.constant('Ess_M2ePro_Model_Walmart_Listing::CONDITION_COLLECTIBLE_VERY_GOOD'),
            M2ePro.php.constant('Ess_M2ePro_Model_Walmart_Listing::CONDITION_COLLECTIBLE_GOOD'),
            M2ePro.php.constant('Ess_M2ePro_Model_Walmart_Listing::CONDITION_COLLECTIBLE_ACCEPTABLE'),
        ];
    },
    ...
    condition_mode_change: function()
    {
        ...
        $('magento_block_walmart_listing_add_images').hide();
        ...
        if (this.value == self.CONDITION_MODE_DEFAULT) {
            ...
            if (attributeCode == M2ePro.php.constant('Ess_M2ePro_Model_Walmart_Listing::CONDITION_NEW')) {
            ...
            if (self.getAvailableConstantsForImages().indexOf(attributeCode) == -1) {
                ...
                $('image_main_mode').selectedIndex = M2ePro.php.constant('Ess_M2ePro_Model_Walmart_Listing::IMAGE_MAIN_MODE_NONE');
                $('image_main_mode').simulate('change');
            } else {
                $('magento_block_walmart_listing_add_images').show();
            }
        } else {
    ...
    image_main_mode_change: function()
    {
        ...
        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Walmart_Listing::IMAGE_MAIN_MODE_NONE')) {
            $('gallery_images_mode_tr').hide();
            $('gallery_images_limit').value = '';
            $('gallery_images_attribute').value = '';
            $('gallery_images_mode').selectedIndex = M2ePro.php.constant('Ess_M2ePro_Model_Walmart_Listing::GALLERY_IMAGES_MODE_NONE');
        }

        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Walmart_Listing::IMAGE_MAIN_MODE_ATTRIBUTE')) {
    ...
    gallery_images_mode_change: function()
    {
        ...
        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Walmart_Listing::GALLERY_IMAGES_MODE_PRODUCT')) {
            self.updateHiddenValue(this, $('gallery_images_limit'));
        }

        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Walmart_Listing::GALLERY_IMAGES_MODE_ATTRIBUTE')) {
    ...
    gift_wrap_mode_change: function()
    {
        ...
        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Walmart_Listing::GIFT_WRAP_MODE_ATTRIBUTE')) {
    ...
    gift_message_mode_change: function()
    {
        ...
        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Walmart_Listing::GIFT_MESSAGE_MODE_ATTRIBUTE')) {

window.CategoryTemplateGrid = Class.create(ListingGrid, {
    ...
    prepareActions: function($super)
    {
        ...
        this.actions = Object.extend(this.actions, {
            ...
            setCategoryTemplateAction: (function() {
                this.templateCategory.validateProductsForTemplateCategoryAssign(this.getSelectedProductsString(), null);
            }).bind(this),

            setCategoryTemplateByCategoryAction: (function() {
                this.templateCategory.validateProductsForTemplateCategoryAssign(this.getSelectedProductsStringFromCategory(), this.getSelectedCategories());
            }).bind(this)
        });
    },
    ...
    {
        this.templateCategory.validateProductsForTemplateCategoryAssign(this.getSelectedProductsStringFromCategory(id), id);
    },
            ...
            onSuccess: function(transport) {
                ...
                new Ajax.Request(M2ePro.url.mapToTemplateCategory, {
                    ...
                    onSuccess: function(transport) {
                        ...
                        self.templateCategory.gridHandler.unselectAllAndReload();

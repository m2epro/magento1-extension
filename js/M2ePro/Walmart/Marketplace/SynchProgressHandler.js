WalmartMarketplaceSynchProgressHandler = Class.create(SynchProgressHandler, {
    ...
    startGetExecutingInfo: function(callBackWhenEnd)
    {
        ...
        var self = this;
        new Ajax.Request(M2ePro.url.get('adminhtml_walmart_marketplace/synchGetExecutingInfo'), {
            method:'get',
            asynchronous: true,

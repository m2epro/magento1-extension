window.WalmartTemplateProductTaxCode = Class.create(WalmartTemplateEdit, {
    ...
    productTaxCodeModeChange: function()
    {
        ...
        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Walmart_Template_ProductTaxCode::PRODUCT_TAX_CODE_MODE_VALUE')) {
            ...
            WalmartTemplateProductTaxCodeObj.updateHiddenValue(this, $('product_tax_code_attribute'));
        }
    }

WalmartTemplateCategoryCategoriesSpecificHandler = Class.create();
WalmartTemplateCategoryCategoriesSpecificHandler.prototype = Object.extend(new CommonHandler(), {
    ...
    initialize: function()
    {
        ...
        self.dictionaryHelper = new WalmartTemplateCategoryCategoriesSpecificDictionary();
    ...
    initValidation: function()
    {
        ...
        Validation.add('M2ePro-specifics-validation', M2ePro.translator.translate('The value is incorrect.'), function(value, element) {
        ...
        Validation.add('M2ePro-specificAttributes-validation', M2ePro.translator.translate('The value is incorrect.'), function(value, element) {
    ...
    initThemeAttributes: function()
    {
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_walmart_template_category/getVariationThemeAttributes'), {
            method: 'get',
            asynchronous: false,
            parameters: {
    ...
    initSpecifics: function()
    {
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_walmart_template_category/getAllSpecifics'), {
            method: 'get',
            asynchronous: true,
            parameters: {
                marketplace_id:     $('marketplace_id').value,
    ...
    {
        var specifics = this.dictionaryHelper.getChildSpecifics({'specific_id': null});
    ...
    renderSpecific: function(indexedXpath, params)
    {
        ...
        if (this.dictionaryHelper.isSpecificTypeContainer(dictionarySpecific)) {
            renderer = new WalmartTemplateCategoryCategoriesSpecificBlockRenderer();
        }
        ...
        if (this.dictionaryHelper.isSpecificTypeSelect(dictionarySpecific) ||
            ...
            renderer = new WalmartTemplateCategoryCategoriesSpecificGridRowRenderer();
        }

WalmartTemplateCategoryCategoriesChooserHandler = Class.create();
WalmartTemplateCategoryCategoriesChooserHandler.prototype = Object.extend(new CommonHandler(), {
    ...
    showEditCategoryPopUp: function()
    {
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_walmart_template_category/getCategoryChooserHtml'), {
            method: 'post',
            parameters: {
    ...
    renderChildCategories: function(parentCategoryId)
    {
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_walmart_template_category/getChildCategories'), {
            method: 'post',
            parameters: {
                marketplace_id     : $('marketplace_id').value,
    ...
    {
        var self = WalmartTemplateCategoryCategoriesChooserHandlerObj;
        ...
        WalmartTemplateCategoryHandlerObj.resetCategory();
        self.specificHandler.resetFormDataSpecifics();

        if (self.preloadedSelectedCategoryObj) {
            WalmartTemplateCategoryHandlerObj.setCategory(self.preloadedSelectedCategoryObj);
    ...
    refreshWalmartCategories: function()
    {
        var self = WalmartTemplateCategoryCategoriesChooserHandlerObj;
        var win = window.open(M2ePro.url.get('adminhtml_walmart_marketplace/index'));
    ...
    saveRecentCategory: function()
    {
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_walmart_template_category/saveRecentCategory'), {
            method     : 'post',
            parameters : {
                marketplace_id : $('marketplace_id').value,
    ...
    search: function()
    {
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_walmart_template_category/searchCategory'), {
            method: 'post',
            parameters: {
                marketplace_id: $('marketplace_id').value,
                query:          query.trim()
            ...
            onSuccess: function(transport) {
                ...
                categories.each(function(categoryInfo) {
                    ...
                    tr.appendChild(new Element('td').update(WalmartTemplateCategoryHandlerObj.getInterfaceCategoryPath(categoryInfo, true)));

                    var link = new Element('a', {href: '#'}).update(M2ePro.translator.translate('Select'));
                    link.observe('click', function() {
                        var categoryPath = WalmartTemplateCategoryHandlerObj.getInterfaceCategoryPath(categoryInfo);
    ...
    getCategoryInfoFromDictionaryByCategoryId: function(categoryId, callback)
    {
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_walmart_template_category/getCategoryInfoByCategoryId'), {
            method: 'post',
            asynchronous: true,
            parameters: {
                marketplace_id : $('marketplace_id').value,
    ...
    getCategoryInfoFromDictionaryBrowseNodeId: function(browsenodeId, categoryPath, callback)
    {
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_walmart_template_category/getCategoryInfoByBrowseNodeId'), {
            method: 'post',
            asynchronous: true,
            parameters: {
                marketplace_id     : $('marketplace_id').value,
    ...
    {
        var path = WalmartTemplateCategoryHandlerObj.getInterfaceCategoryPath(categoryInfo, true);

window.WalmartTemplateCategoryCategoriesChooser = Class.create(Common, {
    ...
    {
        var self = WalmartTemplateCategoryCategoriesChooserObj;
        ...
        WalmartTemplateCategoryObj.resetCategory();
        self.specificHandler.resetFormDataSpecifics();

        if (self.preloadedSelectedCategoryObj) {
            WalmartTemplateCategoryObj.setCategory(self.preloadedSelectedCategoryObj);
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_walmart_template_category/searchCategory'), {
            ...
            onSuccess: function(transport) {
                ...
                categories.each(function(categoryInfo) {
                    ...
                    tr.appendChild(new Element('td').update(WalmartTemplateCategoryObj.getInterfaceCategoryPath(categoryInfo, true)));

                    var link = new Element('a', {href: '#'}).update(M2ePro.translator.translate('Select'));
                    link.observe('click', function() {
                        var categoryPath = WalmartTemplateCategoryObj.getInterfaceCategoryPath(categoryInfo);
    ...
    {
        var path = WalmartTemplateCategoryObj.getInterfaceCategoryPath(categoryInfo, true);

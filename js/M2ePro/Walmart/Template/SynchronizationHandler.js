WalmartTemplateSynchronizationHandler = Class.create();
WalmartTemplateSynchronizationHandler.prototype = Object.extend(new WalmartTemplateEditHandler(), {
    ...
    {
        WalmartTemplateSynchronizationHandlerObj.setVirtualTabsAsInactive();
    ...
    {
        var tab = WalmartTemplateSynchronizationHandlerObj.getNavigationTabName(this);
    ...
    checkVirtualTabValidation: function()
    {
        ...
        failedItems.each(function(el) {
            var tab = WalmartTemplateSynchronizationHandlerObj.getNavigationTabName(el);
        ...
        if (failedItems.length > 0) {
            ...
            var tab = WalmartTemplateSynchronizationHandlerObj.getNavigationTabName(failedItems.shift());
    ...
    validateForm: function()
    {
        ...
        WalmartTemplateSynchronizationHandlerObj.checkVirtualTabValidation();
    ...
    {
        var self = WalmartTemplateSynchronizationHandlerObj;

ControlPanelDatabaseGridHandler = Class.create(GridHandler, {
    ...
    {
        var selectedIds = id ? id : ControlPanelDatabaseGridHandlerObj.getSelectedProductsString();
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_controlPanel_database/deleteTableRows'), {
            ...
            onSuccess: function(transport) {
                ControlPanelDatabaseGridHandlerObj.getGridObj().reload()
            }
        });
    },
    ...
    {
        var self = ControlPanelDatabaseGridHandlerObj;
    ...
    {
        if (!ControlPanelDatabaseGridHandlerObj.isAnySwitcherEnabled()) {
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_controlPanel_database/updateTableCells'), {
            ...
            onSuccess: function(transport) {
                ControlPanelDatabaseGridHandlerObj.unselectAllAndReload();
    ...
    saveTableCell: function(rowId, columnName)
    {
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_controlPanel_database/updateTableCells'), {
            ...
            parameters: params,
            onSuccess: function(transport) {
                ControlPanelDatabaseGridHandlerObj.switchCellToView(cellId);
                ControlPanelDatabaseGridHandlerObj.getGridObj().reload();
            }
        });
    },
    ...
    onKeyDownEdit: function(rowId, columnName, event)
    {
        ...
        ControlPanelDatabaseGridHandlerObj.saveTableCell(rowId, columnName);
        return false;
    },

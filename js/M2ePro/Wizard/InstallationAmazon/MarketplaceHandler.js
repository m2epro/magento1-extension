WizardInstallationAmazonMarketplaceHandler = Class.create();
WizardInstallationAmazonMarketplaceHandler.prototype = Object.extend(new MarketplaceHandler(), {
    ...
    runNextMarketplaceNow: function()
    {
        ...
        self.synchProgressObj.runTask(
            ...
            '', 'WizardInstallationAmazonMarketplaceHandlerObj.runNextMarketplaceNow();'
        );

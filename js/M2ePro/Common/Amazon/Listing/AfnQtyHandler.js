CommonAmazonListingAfnQtyHandler = Class.create();
CommonAmazonListingAfnQtyHandler.prototype = {
    ...
    showAfnQty: function(el, selectedSku, selectedProductId, accountId) {
        ...
        var i = 50,
            hasSelected = false;
        $$('.m2ePro-online-sku-value').each(function (skuEl) {
            if (i === 0) {
                throw $break;
            }
        ...
        new Ajax.Request(M2ePro.url.getAFNQtyBySku, {
            method: 'post',
            parameters: {
                skus: skusStr,

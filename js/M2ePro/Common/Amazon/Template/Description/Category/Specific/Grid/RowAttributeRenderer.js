CommonAmazonTemplateDescriptionCategorySpecificGridRowAttributeRenderer = Class.create(CommonAmazonTemplateDescriptionCategorySpecificGridRowRenderer, {
    ...
    renderChooseMode: function()
    {
        var select = new Element('select', {
            ...
            'class'       : this.isAttributeRequired() ? 'M2ePro-required-when-visible' : '',
            'style'       : 'width: 93.2%;'
        });
    ...
    getTextTypeInput: function()
    {
        var input = new Element('input', {
            ...
            'type'            : 'text',
            'class'           : 'input-text M2ePro-specificAttributes-validation' + (this.isAttributeRequired() ? ' M2ePro-required-when-visible' : ''),
            'style'           : 'display: none; width: 91.3%;'
        });

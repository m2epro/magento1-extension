...
CommonAmazonTemplateDescriptionCategorySpecificRenderer.prototype = {
    ...
    hideButton: function(button)
    {
        ...
        this.specificHandler.dictionaryHelper.isSpecificTypeContainer(this.specific) ? button.style.display = 'none'
    ...
    showButton: function(button)
    {
        ...
        this.specificHandler.dictionaryHelper.isSpecificTypeContainer(this.specific) ? button.style.display = 'inline-block'

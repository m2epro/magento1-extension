EbayListingPickupStoreGridHandler = Class.create(ListingGridHandler, {
        ...
        new Ajax.Request(M2ePro.url.get('*/productsStep'), {
            ...
            onSuccess: function(transport) {
                ...
                $('done_button').observe('click', function() {
                    var checkedIds = EbayListingPickupStoreStepProductsGridHandlerObj.getCheckedValues();
                    if (checkedIds == '') {
        ...
        new Ajax.Request(M2ePro.url.get('*/storesStep'), {
            ...
            onSuccess: function(transport) {
                ...
                $('back_button').observe('click', function(e) {
                    e.preventDefault();
                    var checked = EbayListingPickupStoreStepProductsGridHandlerObj.getCheckedValues();
                    self.pickupStoreStepProducts(listingId, function() {
                        var gridMassAcction = EbayListingPickupStoreStepProductsGridHandlerObj.getGridMassActionObj();
                ...
                $('save_button').observe('click', function(e) {
                    e.preventDefault();
                    var productsIds = EbayListingPickupStoreStepProductsGridHandlerObj.getCheckedValues(),
                        storesIds = EbayListingPickupStoreStepStoresGridHandlerObj.getCheckedValues();
    ...
    createHelpViewAllLogHtml: function(rowId)
    {
        ...
        return '<div class="hl_footer">' +
               '<a href="#" onclick="EbayListingPickupStoreGridHandlerObj.getLogGrid('+id+');">'+
    ...
    {
        var self = EbayListingPickupStoreGridHandlerObj;

        var isFrame = window.top.document.getElementById('ebayPickupStoreVariationsGridIframe');
        if (isFrame) {
            setTimeout(function() {
                var topObject = window.top.EbayListingPickupStoreGridHandlerObj;
                ...
                topObject.getLogGrid(rowId, function() {
                    ...
                    EbayListingPickupStoreGridHandlerObj.openVariationPopUp(
                        params.product_id,
                        params.title,

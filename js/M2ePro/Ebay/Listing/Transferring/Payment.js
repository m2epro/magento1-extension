window.EbayListingTransferringPayment = Class.create(Common, {
    ...
    payNowAction: function(amount, currency, account, closeCallback)
    {
        var content =
            ...
            '<div style="float: right; margin: 10px 0;">' +
                ...
                '&nbsp;&nbsp;&nbsp;' +
                '<button class="confirm_button" onclick="EbayListingTransferringPaymentObj.confirm();">'+M2ePro.translator.translate('Confirm')+'</button>' +
                '' +
            '</div>';
    ...
    confirm: function()
    {
        if (!EbayListingTransferringPaymentObj.validate()) {
            return;
        }
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_ebay_listing_transferring/getPaymentUrl'), {
            ...
            onSuccess: function(transport) {
                ...
                var intervalId = setInterval(function() {
                    ...
                    if (typeof EbayListingTransferringObj != 'undefined') {
                        EbayListingTransferringObj.refreshTranslationAccount();
                    }

                }, 1000);

                EbayListingTransferringPaymentObj.popUp.close();
            }
        });
    }

    ...
    renderShippingMethods: function(shippingMethods)
    {
        ...
        shippingMethods.each(function(service, i) {
            ...
            if (service.cost_mode == M2ePro.php.constant('Ess_M2ePro_Model_Ebay_Template_Shipping_Service::COST_MODE_CUSTOM_VALUE')) {
                ...
                EbayTemplateShippingObj.replaceSelectWithInputHidden(row.down('.cost-mode'));
                EbayTemplateShippingObj.replaceSelectWithInputHidden(row.down('.shipping-cost-ca select'));
                EbayTemplateShippingObj.replaceSelectWithInputHidden(row.down('.shipping-cost-additional-ca select'));
            }

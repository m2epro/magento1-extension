AmazonMarketplaceSynchProgressHandler = Class.create(SynchProgressHandler, {
    ...
    startGetExecutingInfo: function(callBackWhenEnd)
    {
        ...
        var self = this;
        new Ajax.Request(M2ePro.url.get('adminhtml_amazon_marketplace/synchGetExecutingInfo'), {
            method:'get',
            asynchronous: true,

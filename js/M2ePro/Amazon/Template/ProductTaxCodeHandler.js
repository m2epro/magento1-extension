AmazonTemplateProductTaxCodeHandler = Class.create();
AmazonTemplateProductTaxCodeHandler.prototype = Object.extend(new AmazonTemplateEditHandler(), {
    ...
    productTaxCodeModeChange: function()
    {
        ...
        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Amazon_Template_ProductTaxCode::PRODUCT_TAX_CODE_MODE_VALUE')) {
            ...
            AmazonTemplateProductTaxCodeHandlerObj.updateHiddenValue(this, $('product_tax_code_attribute'));
        }
    }

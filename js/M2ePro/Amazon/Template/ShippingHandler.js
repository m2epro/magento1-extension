AmazonTemplateShippingHandler = Class.create();
AmazonTemplateShippingHandler.prototype = Object.extend(new AmazonTemplateEditHandler(), {
    ...
    templateNameModeChange: function()
    {
        ...
        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Amazon_Template_Shipping::TEMPLATE_NAME_VALUE')) {
            ...
            AmazonTemplateShippingHandlerObj.updateHiddenValue(this, $('template_name_attribute'));
        }
    }

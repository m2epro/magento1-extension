AmazonTemplateDescriptionDefinitionHandler = Class.create();
AmazonTemplateDescriptionDefinitionHandler.prototype = Object.extend(new CommonHandler(), {
    ...
    onChangeMsrpRrpMode: function()
    {
        ...
        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Amazon_Template_Description_Definition::MSRP_RRP_MODE_ATTRIBUTE')) {
            AmazonTemplateDescriptionDefinitionHandlerObj.updateHiddenValue(this, customAttribute);
        }
    },

AmazonTemplateDescriptionCategorySpecificHandler = Class.create();
AmazonTemplateDescriptionCategorySpecificHandler.prototype = Object.extend(new CommonHandler(), {
    ...
    initThemeAttributes: function()
    {
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_amazon_template_description/getVariationThemeAttributes'), {
            method: 'get',
            asynchronous: false,
            parameters: {
    ...
    initSpecifics: function()
    {
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_amazon_template_description/getAllSpecifics'), {
            method: 'get',
            asynchronous: true,
            parameters: {
                marketplace_id:     $('marketplace_id').value,

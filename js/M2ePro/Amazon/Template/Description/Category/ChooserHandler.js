AmazonTemplateDescriptionCategoryChooserHandler = Class.create();
AmazonTemplateDescriptionCategoryChooserHandler.prototype = Object.extend(new CommonHandler(), {
    ...
    showEditCategoryPopUp: function()
    {
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_amazon_template_description/getCategoryChooserHtml'), {
            method: 'post',
            parameters: {
    ...
    renderChildCategories: function(parentCategoryId)
    {
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_amazon_template_description/getChildCategories'), {
            method: 'post',
            parameters: {
                marketplace_id     : $('marketplace_id').value,
    ...
    {
        var self = AmazonTemplateDescriptionCategoryChooserHandlerObj;
        var win = window.open(M2ePro.url.get('adminhtml_amazon_marketplace/index'));
    ...
    saveRecentCategory: function()
    {
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_amazon_template_description/saveRecentCategory'), {
            method     : 'post',
            parameters : {
                marketplace_id : $('marketplace_id').value,
    ...
    search: function()
    {
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_amazon_template_description/searchCategory'), {
            method: 'post',
            parameters: {
                marketplace_id: $('marketplace_id').value,
                query:          query.trim()
    ...
    getCategoryInfoFromDictionaryByCategoryId: function(categoryId, callback)
    {
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_amazon_template_description/getCategoryInfoByCategoryId'), {
            method: 'post',
            asynchronous: true,
            parameters: {
                marketplace_id : $('marketplace_id').value,
    ...
    getCategoryInfoFromDictionaryBrowseNodeId: function(browsenodeId, categoryPath, callback)
    {
        ...
        new Ajax.Request(M2ePro.url.get('adminhtml_amazon_template_description/getCategoryInfoByBrowseNodeId'), {
            method: 'post',
            asynchronous: true,
            parameters: {
                marketplace_id     : $('marketplace_id').value,

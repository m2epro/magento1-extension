AmazonTemplateSellingFormatHandler = Class.create(AmazonTemplateEditHandler, {
    ...
    regular_sale_price_start_date_mode_change: function()
    {
        ...
        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Amazon_Template_SellingFormat::DATE_VALUE')) {
            ...
            AmazonTemplateSellingFormatHandlerObj.updateHiddenValue(this, $('regular_sale_price_start_date_custom_attribute'));
        }
    ...
    regular_sale_price_end_date_mode_change: function()
    {
        ...
        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Amazon_Template_SellingFormat::DATE_VALUE')) {
            ...
            AmazonTemplateSellingFormatHandlerObj.updateHiddenValue(this, $('regular_sale_price_end_date_custom_attribute'));
        }
    ...
    business_discounts_mode_change: function()
    {
        ...
        AmazonTemplateSellingFormatHandlerObj.discountRulesCount = 0;
    ...
    addRow: function()
    {
        ...
        var i = AmazonTemplateSellingFormatHandlerObj.discountRulesCount;
        ...
        AmazonTemplateSellingFormatHandlerObj.discountRulesCount++;

        if (AmazonTemplateSellingFormatHandlerObj.discountRulesCount >= 5) {
            $$('.add_discount_rule_button').each(function (el) {
                el.hide();
            });
        }
    ...
    removeRow: function(btnEl)
    {
        ...
        if (AmazonTemplateSellingFormatHandlerObj.discountRulesCount == 0) {
    ...
    renderDiscountRules: function(discountRules)
    {
        ...
        discountRules.each(function(rule, i) {
            var row = AmazonTemplateSellingFormatHandlerObj.addRow();

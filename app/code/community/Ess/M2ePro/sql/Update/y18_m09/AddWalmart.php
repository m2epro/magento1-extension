...
class Ess_M2ePro_Sql_Update_y18_m09_AddWalmart extends Ess_M2ePro_Model_Upgrade_Feature_AbstractFeature
{
    ...
    public function execute()
    {
        ...
        $this->installer->getTableModifier('amazon_listing_product')
            ->addColumn(
                'is_details_data_changed', 'TINYINT(2) UNSIGNED NOT NULL', '0', 'online_images_data', true, false
            )
            ->addColumn(
                'is_images_data_changed', 'TINYINT(2) UNSIGNED NOT NULL', '0', 'is_details_data_changed', true, false
            )
            ->commit();

        $this->installer->getTableModifier('ebay_indexer_listing_product_parent')
            ->dropColumn('component_mode');

        $this->installer->getTableModifier('amazon_indexer_listing_product_parent')
            ->dropColumn('component_mode');
...
INSERT INTO `m2epro_config` (`group`,`key`,`value`,`notice`,`update_date`,`create_date`) VALUES
  ...
  'sku_modification_custom_value', NULL, NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/configuration/', 'generate_sku_mode', '0', NULL,
  '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ...
  ('/cron/task/walmart/listing/other/resolve_title/', 'interval', '60', 'in seconds', '2013-05-08 00:00:00',
   '2013-05-08 00:00:00'),
  ('/cron/task/walmart/listing/other/channel/synchronize_data/',
  'mode', '1', '0 - disable, \r\n1 - enable', '2013-05-08 00:00:00',
   '2013-05-08 00:00:00'),
  ('/cron/task/walmart/listing/other/channel/synchronize_data/',
  'interval', '86400', 'in seconds', '2013-05-08 00:00:00',
   '2013-05-08 00:00:00'),
  ('/cron/task/walmart/listing/product/channel/synchronize_data/',
  'mode', '1', '0 - disable, \r\n1 - enable', '2013-05-08 00:00:00',
   '2013-05-08 00:00:00'),
  ('/cron/task/walmart/listing/product/channel/synchronize_data/',
  'interval', '86400', 'in seconds', '2013-05-08 00:00:00',
   '2013-05-08 00:00:00'),
  ('/cron/task/walmart/listing/product/channel/synchronize_data/blocked/',
  'mode', '1', '0 - disable, \r\n1 - enable', '2013-05-08 00:00:00',
   '2013-05-08 00:00:00'),
  ('/cron/task/walmart/listing/product/channel/synchronize_data/blocked/',
  'interval', '86400', 'in seconds', '2013-05-08 00:00:00',
   '2013-05-08 00:00:00'),
  ('/cron/task/walmart/listing/product/run_variation_parent_processors/',
  'mode', '1', '0 - disable, \r\n1 - enable', '2013-05-08 00:00:00',
   '2013-05-08 00:00:00'),
  ('/cron/task/walmart/listing/product/run_variation_parent_processors/',
  'interval', '60', 'in seconds', '2013-05-08 00:00:00',
   '2013-05-08 00:00:00'),
  ...
  ('/cron/task/walmart/order/shipping/', 'interval', '60', 'in seconds', '2013-05-08 00:00:00',
   '2013-05-08 00:00:00'),
  ('/listing/product/inspector/walmart/',
  'max_allowed_instructions_count', '2000', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/listing/product/revise/total/walmart/', 'mode', '0', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/listing/product/revise/total/walmart/',
  'max_allowed_instructions_count', '2000', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/scheduled_data/',
  'limit', '20000', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/instructions/cron/',
  'listings_products_per_one_time', '1000', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/list/',
  'priority_coefficient', '25', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/list/',
  'wait_increase_coefficient', '100', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/list/',
  'min_allowed_wait_interval', '3600', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/relist/',
  'priority_coefficient', '125', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/relist/',
  'wait_increase_coefficient', '100', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/relist/',
  'min_allowed_wait_interval', '1800', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/revise_qty/',
  'priority_coefficient', '500', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/revise_qty/',
  'wait_increase_coefficient', '100', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/revise_qty/',
  'min_allowed_wait_interval', '900', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/revise_price/',
  'priority_coefficient', '250', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/revise_price/',
  'wait_increase_coefficient', '100', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/revise_price/',
  'min_allowed_wait_interval', '1800', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/revise_details/',
  'priority_coefficient', '50', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/revise_details/',
  'wait_increase_coefficient', '100', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/revise_details/',
  'min_allowed_wait_interval', '7200', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ...
  'priority_coefficient', '1000', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/stop/',
  'wait_increase_coefficient', '100', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/stop/',
  'min_allowed_wait_interval', '600', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/delete/',
  'priority_coefficient', '1000', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/delete/',
  'wait_increase_coefficient', '100', NULL, '2013-05-08 00:00:00', '2013-05-08 00:00:00'),
  ('/walmart/listing/product/action/delete/',

...
class Ess_M2ePro_Sql_Upgrade_v6_0_3__v6_0_4_AllFeatures extends Ess_M2ePro_Model_Upgrade_Feature_AbstractFeature
{
    //########################################
                ...
                if (is_null($data['account_id'])) {
                    if (!isset($tempData[$data['shipping_id']])) {
                        if (!is_null($data['shipping_local'])) {
                            $tempData[$data['shipping_id']]['local'] = array();
                        }

                        if (!is_null($data['shipping_international'])) {
                            $tempData[$data['shipping_id']]['international'] = array();
                        }
                    }
                    continue;
                }
...
SQL
        ...
        /*
            ...
            ADD COLUMN
                adding_template_other_category_id INT(11) UNSIGNED DEFAULT NULL AFTER `adding_template_category_id`,

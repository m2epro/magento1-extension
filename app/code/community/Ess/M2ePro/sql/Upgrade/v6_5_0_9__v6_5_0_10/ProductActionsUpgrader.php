...
class ProductActionsUpgrader
{
    ...
    private function moveToBackup()
    {
        ...
        $this->_installer->getTableModifier('processing')->changeColumn(
...
SQL
        ...
        $this->_installer->getTableModifier('listing_product')->addColumn(
    ...
    {
        return $this->_installer->getTable('m2epro_'.$table);
    }

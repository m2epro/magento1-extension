...
class Ess_M2ePro_Sql_Upgrade_v5_0_3__v5_0_4_AllFeatures extends Ess_M2ePro_Model_Upgrade_Feature_AbstractFeature
{
    //########################################
...
SQL
        ...
        $tempTable = $this->_installer->getTable('m2epro_buy_template_new_product_core');
...
SQL
        ...
        $tempTable = $this->_installer->getTable('m2epro_amazon_template_new_product');
        ...
        $tempTable = $this->_installer->getTable('m2epro_amazon_template_new_product_description');
        $tempTableIndexList = $connection->getIndexList($tempTable);
        ...
        if (!isset($tempTableIndexList[strtoupper('package_weight_unit_of_measure_mode')])) {
            $connection->addKey(
                $tempTable, 'package_weight_unit_of_measure_mode', 'package_weight_unit_of_measure_mode'
            );
        }

        if (!isset($tempTableIndexList[strtoupper('shipping_weight_unit_of_measure_mode')])) {
            $connection->addKey(
                $tempTable, 'shipping_weight_unit_of_measure_mode', 'shipping_weight_unit_of_measure_mode'
            );
        }

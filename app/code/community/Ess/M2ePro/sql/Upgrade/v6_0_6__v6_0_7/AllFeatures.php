...
class Ess_M2ePro_Sql_Upgrade_v6_0_6__v6_0_7_AllFeatures extends Ess_M2ePro_Model_Upgrade_Feature_AbstractFeature
{
    //########################################
    ...
    public function execute()
    {
        ...
        if ($connection->tableColumnExists($tempTable, 'dispatch_time') !== false &&
            ...
            $connection->changeColumn(
                $tempTable,'dispatch_time','dispatch_time_value', 'INT(11) UNSIGNED NOT NULL DEFAULT 0'
            );
        }

...
CREATE TABLE `{$this->_installer->getTable('m2epro_walmart_listing')}` (
  ...
  `condition_mode` TINYINT(2) UNSIGNED DEFAULT 0,
  `condition_custom_attribute` VARCHAR(255) DEFAULT NULL,
...
CREATE TABLE `{$this->_installer->getTable('m2epro_walmart_listing_product')}` (
  ...
  `is_not_mapped_to_existing_channel_item` TINYINT(2) UNSIGNED NOT NULL DEFAULT 0,

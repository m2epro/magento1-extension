...
$installer->getCacheConfigModifier()->delete("/view/ebay/template/selling_format/multi_currency_marketplace_2/");
$installer->getCacheConfigModifier()->delete("/view/ebay/template/selling_format/multi_currency_marketplace_19/");
...
$installer->getTableModifier('ebay_template_shipping')
    ...
    ->renameColumn('international_shipping_discount_profile_id', 'international_shipping_discount_combined_profile_id');
...
$connection->insertMultiple($installer->getTablesObject()->getFullName('wizard'), array_values($newWizardsData));
...
foreach ($tablesForRemoveDataByComponentMode as $table) {
    $connection->delete($installer->getTablesObject()->getFullName($table), array('component_mode = ?' => 'buy'));
}
...
if ($installer->getTablesObject()->isExists('amazon_template_shipping_override_service')) {
    $connection->dropTable($installer->getTablesObject()->getFullName('amazon_template_shipping_override_service'));
}
...
$installer->getTableModifier('amazon_template_synchronization')
    ...
    ->addColumn('stop_mode', 'TINYINT(2) UNSIGNED NOT NULL', NULL, 'relist_qty_calculated_value_max', false, false)
    ->commit();
...
$installer->getTableModifier('ebay_template_synchronization')
    ...
    ->addColumn('revise_update_other', 'TINYINT(2) UNSIGNED NOT NULL', NULL, 'revise_update_return', false, false)
    ->addColumn('stop_mode', 'TINYINT(2) UNSIGNED NOT NULL', NULL, 'relist_qty_calculated_value_max', false, false)
    ->commit();
...
$amazonOrderActionProcessingTable = $installer->getTablesObject()->getFullName('amazon_order_action_processing');
...
$connection->delete($installer->getTablesObject()->getFullName('config'), array('`group` like \'/cron/task/%\''));

$installer->getMainConfigModifier()->insert(
    '/cron/task/system/archive_old_orders/', 'mode', '1', '0 - disable, \r\n1 - enable'
);
$installer->getMainConfigModifier()->insert('/cron/task/system/archive_old_orders/', 'interval', '3600', 'in seconds');
$installer->getMainConfigModifier()->insert(
    '/cron/task/system/clear_old_logs/', 'mode', '1', '0 - disable, \r\n1 - enable'
);
$installer->getMainConfigModifier()->insert('/cron/task/system/clear_old_logs/', 'interval', '86400', 'in seconds');
$installer->getMainConfigModifier()->insert(
...
$installer->getMainConfigModifier()->insert('/cron/task/ebay/order/create_failed/', 'interval', '60', 'in seconds');
$installer->getMainConfigModifier()->insert(
...
$installer->getMainConfigModifier()->insert('/cron/task/ebay/order/reserve_cancel/', 'interval', '60', 'in seconds');
$installer->getMainConfigModifier()->insert(
...
$installer->getMainConfigModifier()->insert('/ebay/listing/product/action/list/', 'priority_coefficient', '25', NULL);
$installer->getMainConfigModifier()->insert(
...
$installer->getMainConfigModifier()->insert('/ebay/listing/product/action/stop/', 'priority_coefficient', '1000', NULL);
$installer->getMainConfigModifier()->insert(
...
$installer->getMainConfigModifier()->insert('/cron/task/amazon/order/receive/', 'interval', '60', 'in seconds');
$installer->getMainConfigModifier()->insert(
    '/cron/task/amazon/order/create_failed/', 'mode', '1', '0 - disable, \r\n1 - enable'
);
$installer->getMainConfigModifier()->insert('/cron/task/amazon/order/create_failed/', 'interval', '60', 'in seconds');
$installer->getMainConfigModifier()->insert(
...
$installer->getMainConfigModifier()->insert('/cron/task/amazon/order/reserve_cancel/', 'interval', '60', 'in seconds');
$installer->getMainConfigModifier()->insert(
...
$installer->getMainConfigModifier()->insert('/amazon/listing/product/action/list/', 'priority_coefficient', '25', NULL);
$installer->getMainConfigModifier()->insert(
...
$responserModelNameMap = array(
    ...
    'M2ePro/Amazon_Synchronization_Orders_Cancel_Responser' => 'M2ePro/Cron_Task_Amazon_Order_Cancel_Responser',
    'M2ePro/Amazon_Synchronization_Orders_Receive_Details_Responser'
        => 'M2ePro/Cron_Task_Amazon_Order_Receive_Details_Responser',
    'M2ePro/Amazon_Synchronization_Orders_Refund_Responser' => 'M2ePro/Cron_Task_Amazon_Order_Refund_Responser',
    'M2ePro/Amazon_Synchronization_Orders_Update_Responser' => 'M2ePro/Cron_Task_Amazon_Order_Update_Responser',
...
foreach ($processings as $processing) {
    ...
    if (isset($params['responser_model_name']) && isset($responserModelNameMap[$params['responser_model_name']])) {
...
$installer->getTableModifier('processing')->addColumn('type', 'TINYINT(2) UNSIGNED NOT NULL', 0, 'params', true);

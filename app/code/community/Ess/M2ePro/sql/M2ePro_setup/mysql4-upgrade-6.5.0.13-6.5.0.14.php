...
$installer->getTableModifier('amazon_listing_product_repricing')
    ->addColumn('last_updated_regular_price', 'DECIMAL(12, 4) UNSIGNED', 'NULL', 'online_max_price', false, false)
    ->addColumn('last_updated_min_price', 'DECIMAL(12, 4) UNSIGNED', 'NULL', 'last_updated_regular_price', false, false)
    ->addColumn('last_updated_max_price', 'DECIMAL(12, 4) UNSIGNED', 'NULL', 'last_updated_min_price', false, false)
    ->addColumn('last_updated_is_disabled', 'TINYINT(2) UNSIGNED', 'NULL', 'last_updated_max_price', false, false)
    ->commit();

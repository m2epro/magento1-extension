...
class Ess_M2ePro_Helper_View_Walmart_Component extends Mage_Core_Helper_Abstract
{
    //########################################
    ...
    protected function removeEbayFromComponentsArray($components)
    {
        ...
        foreach ($components as $key => $value) {
            if (Ess_M2ePro_Helper_Component_Walmart::NICK === $key) {
                $resultComponents[] = $key;
            } elseif (Ess_M2ePro_Helper_Component_Walmart::NICK === $value) {

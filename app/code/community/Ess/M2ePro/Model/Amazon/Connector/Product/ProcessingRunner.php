    ...
    extends Ess_M2ePro_Model_Connector_Command_Pending_Processing_Single_Runner
{
    ...
    /** @var Ess_M2ePro_Model_Amazon_Listing_Product_Action_Processing $_processingAction */
    ...
    public function setProcessingAction(Ess_M2ePro_Model_Amazon_Listing_Product_Action_Processing $processingAction)
    {
    ...
    protected function eventBefore()
    {
        ...
        $processingAction = Mage::getModel('M2ePro/Amazon_Listing_Product_Action_Processing');
    ...
    protected function getProcessingActionType()
    {
        ...
        switch ($params['action_type']) {
            case Ess_M2ePro_Model_Listing_Product::ACTION_LIST:
                return Ess_M2ePro_Model_Amazon_Listing_Product_Action_Processing::TYPE_ADD;

            case Ess_M2ePro_Model_Listing_Product::ACTION_RELIST:
            case Ess_M2ePro_Model_Listing_Product::ACTION_REVISE:
            case Ess_M2ePro_Model_Listing_Product::ACTION_STOP:
                return Ess_M2ePro_Model_Amazon_Listing_Product_Action_Processing::TYPE_UPDATE;

            case Ess_M2ePro_Model_Listing_Product::ACTION_DELETE:
                return Ess_M2ePro_Model_Amazon_Listing_Product_Action_Processing::TYPE_DELETE;

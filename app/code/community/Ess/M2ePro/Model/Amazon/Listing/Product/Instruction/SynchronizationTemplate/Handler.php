...
class Ess_M2ePro_Model_Amazon_Listing_Product_Instruction_SynchronizationTemplate_Handler
    implements Ess_M2ePro_Model_Listing_Product_Instruction_Handler_Interface
{
    ...
    private function getCheckerModel($checkerNick)
    {
        ...
        if (!($checkerModel instanceof
                Ess_M2ePro_Model_Amazon_Listing_Product_Instruction_SynchronizationTemplate_Checker_Abstract)) {
            throw new Ess_M2ePro_Model_Exception_Logic(
                sprintf(

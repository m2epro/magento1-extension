...
class Ess_M2ePro_Model_Amazon_Synchronization_Defaults_UpdateDefectedListingsProducts_Requester
    extends Ess_M2ePro_Model_Connector_Amazon_Inventory_Get_Defected_ItemsRequester
{
    //########################################

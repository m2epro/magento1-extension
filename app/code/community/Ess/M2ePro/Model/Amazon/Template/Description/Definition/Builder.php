...
use Ess_M2ePro_Model_Amazon_Template_Description_Definition as Definition;

class Ess_M2ePro_Model_Amazon_Template_Description_Definition_Builder
    extends Ess_M2ePro_Model_ActiveRecord_AbstractBuilder
{
    ...
    protected function prepareData()
    {
        ...
        $data['target_audience'] = $helper->jsonEncode(array_filter($data['target_audience']));
        $data['search_terms'] = $helper->jsonEncode(array_filter($data['search_terms']));
        $data['bullet_points'] = $helper->jsonEncode(array_filter($data['bullet_points']));
    ...
    public function getDefaultData()
    {
        return array(
            ...
            'target_audience'      => Mage::helper('M2ePro')->jsonEncode(array()),

            'search_terms_mode' => Definition::SEARCH_TERMS_MODE_NONE,
            'search_terms'      => Mage::helper('M2ePro')->jsonEncode(array()),
            ...
            'bullet_points'      => Mage::helper('M2ePro')->jsonEncode(array()),

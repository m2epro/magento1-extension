...
class Ess_M2ePro_Model_Amazon_Template_Synchronization_AffectedListingsProducts
    extends Ess_M2ePro_Model_Template_AffectedListingsProducts_Abstract
{
    ...
    public function getObjects(array $filters = array())
    {
        ...
        $listingCollection->addFieldToFilter('template_synchronization_id', $this->_model->getId());

...
use Ess_M2ePro_Model_Cron_Task_Amazon_Listing_Product_Channel_SynchronizeData_ProcessingRunner as ProcessingRunner;

class Ess_M2ePro_Model_Cron_Task_Amazon_Listing_Product_Channel_SynchronizeData
    extends Ess_M2ePro_Model_Cron_Task_Abstract
{
    const NICK = 'amazon/listing/product/channel/synchronize_data';
    ...
    protected function processAccount(Ess_M2ePro_Model_Account $account)
    {
        ...
        if ($collection->getSize()) {
            ...
            $connectorObj = $dispatcherObject->getCustomConnector(
                'Cron_Task_Amazon_Listing_Product_Channel_SynchronizeData_Requester', array(), $account
            );

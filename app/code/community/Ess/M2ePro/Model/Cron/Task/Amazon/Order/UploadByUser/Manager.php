...
class Ess_M2ePro_Model_Cron_Task_Amazon_Order_UploadByUser_Manager
{
    /** @var string */
    ...
    {
        return $this->setIdentifier($account->getChildObject()->getMerchantId());
    }
    ...
    protected function getSettings($key = null)
    {
        $registry = Mage::getModel('M2ePro/Registry')
            ->loadByKey("/amazon/orders/upload_by_user/{$this->_identifier}/");

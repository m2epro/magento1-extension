...
class Ess_M2ePro_Model_Cron_Task_Walmart_Order_Shipping extends Ess_M2ePro_Model_Cron_Task_Abstract
{
    ...
    protected function performActions()
    {
        ...
        foreach ($ordersChangesForProcess as $orderChange) {
            ...
            /** @var Ess_M2ePro_Model_Walmart_Order_Action_Handler_Shipping $actionHandler */
            $actionHandler = Mage::getModel('M2ePro/Walmart_Order_Action_Handler_Shipping');
    ...
    protected function getOrdersChangesForProcess()
    {
        ...
        $collection->addFieldToFilter('action', Ess_M2ePro_Model_Order_Change::ACTION_UPDATE_SHIPPING);

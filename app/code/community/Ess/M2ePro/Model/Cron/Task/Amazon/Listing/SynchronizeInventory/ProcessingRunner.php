...
class Ess_M2ePro_Model_Cron_Task_Amazon_Listing_SynchronizeInventory_ProcessingRunner
    extends Ess_M2ePro_Model_Connector_Command_Pending_Processing_Partial_Runner
{
    ...
    protected function setLocks()
    {
        ...
        $lockItemManager = Mage::getModel('M2ePro/Lock_Item_Manager', array('nick' => self::LOCK_ITEM_PREFIX));
    ...
    protected function unsetLocks()
    {
        ...
        $lockItem = Mage::getModel('M2ePro/Lock_Item_Manager', array('nick' => self::LOCK_ITEM_PREFIX));
        $lockItem->remove();
    ...
    /**
     * @return Ess_M2ePro_Model_Listing_SynchronizeInventory_Amazon_BlockedProductsHandler
     */
    protected function getBlockedProductsHandler()
    {
        return Mage::getModel('M2ePro/Listing_SynchronizeInventory_Amazon_BlockedProductsHandler');
    }

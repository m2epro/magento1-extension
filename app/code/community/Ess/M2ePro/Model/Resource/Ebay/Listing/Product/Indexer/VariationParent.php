...
class Ess_M2ePro_Model_Resource_Ebay_Listing_Product_Indexer_VariationParent
    extends Ess_M2ePro_Model_Resource_Component_Abstract
{
    ...
    {
        $this->_init('M2ePro/Ebay_Listing_Product_Indexer_VariationParent', 'listing_product_id');
    }

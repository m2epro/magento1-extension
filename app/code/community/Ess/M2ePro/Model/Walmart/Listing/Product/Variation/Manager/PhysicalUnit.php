...
abstract class Ess_M2ePro_Model_Walmart_Listing_Product_Variation_Manager_PhysicalUnit
    extends Ess_M2ePro_Model_Walmart_Listing_Product_Variation_Manager_Abstract
{
    //########################################
    ...
    {
        $variationId = Mage::helper('M2ePro/Component_Walmart')
        ...
        foreach ($variation as $option) {
            ...
            Mage::helper('M2ePro/Component_Walmart')->getModel('Listing_Product_Variation_Option')
    ...
    {
        $items = Mage::getModel('M2ePro/Walmart_Item')->getCollection()
        ...
        foreach ($items as $item) {
            /* @var $item Ess_M2ePro_Model_Walmart_Item */
            $item->deleteInstance();
        }
    }
    ...
    private function createChannelItem(array $options)
    {
        ...
        Mage::getModel('M2ePro/Walmart_Item')->setData($data)->save();
    }

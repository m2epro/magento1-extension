...
use Ess_M2ePro_Model_Walmart_Listing_Product_Instruction_SynchronizationTemplate_Checker_Abstract as CheckerAbstract;

class Ess_M2ePro_Model_Walmart_Listing_Product_Instruction_SynchronizationTemplate_Handler
        ...
        if (!($checkerModel instanceof CheckerAbstract)) {
            throw new Ess_M2ePro_Model_Exception_Logic(
                sprintf(
                    ...
                    "Ess_M2ePro_Model_Walmart_Listing_Product_Instruction_SynchronizationTemplate_Checker_Abstract"
                    class',
                    $checkerModelName
                )
            );

...
class Ess_M2ePro_Model_Walmart_Marketplace_Issue_NotUpdated extends Ess_M2ePro_Model_Issue_Locator_Abstract
{
    ...
    public function getIssues()
    {
        ...
        if ($outdatedMarketplaces === false) {
            ...
            Mage::helper('M2ePro/Data_Cache_Permanent')->setValue(
                self::CACHE_KEY, $outdatedMarketplaces, array('walmart','marketplace'), 60*60*24
            );
        }
...
TEXT;
    ...
    {
        return Mage::helper('M2ePro/View_Walmart')->isInstallationWizardFinished() &&
               Mage::helper('M2ePro/Component_Walmart')->isEnabled();
    }

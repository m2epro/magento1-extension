...
class Ess_M2ePro_Model_Ebay_Listing_Product_Instruction_AutoActions_Handler
        ...
        if ($input->hasInstructionWithType(
            ...
            if (!$input->getListingProduct()->isStoppable()) {
                $removeHandler = Mage::getModel(
                    'M2ePro/Listing_Product_RemoveHandler', array('listing_product' => $input->getListingProduct())
                );

...
class Ess_M2ePro_Model_Ebay_Template_OtherCategory_AffectedListingsProducts
    extends Ess_M2ePro_Model_Template_AffectedListingsProducts_Abstract
{
    ...
    public function getObjects(array $filters = array())
    {
        ...
        $listingProductCollection->addFieldToFilter('template_other_category_id', $this->_model->getId());

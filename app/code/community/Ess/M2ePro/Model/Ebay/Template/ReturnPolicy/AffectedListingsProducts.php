...
class Ess_M2ePro_Model_Ebay_Template_ReturnPolicy_AffectedListingsProducts
    extends Ess_M2ePro_Model_Template_AffectedListingsProducts_Abstract
{
    ...
    public function getObjects(array $filters = array())
    {
        ...
        $templateManager->setTemplate(Ess_M2ePro_Model_Ebay_Template_Manager::TEMPLATE_RETURN_POLICY);
        ...
        foreach ($listings as $listing) {
            ...
            $tempListingsProducts = $listingAffectedProducts->getObjects(
                array('template' => Ess_M2ePro_Model_Ebay_Template_Manager::TEMPLATE_RETURN_POLICY)
            );

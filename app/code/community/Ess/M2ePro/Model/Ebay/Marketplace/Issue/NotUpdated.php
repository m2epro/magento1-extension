...
class Ess_M2ePro_Model_Ebay_Marketplace_Issue_NotUpdated extends Ess_M2ePro_Model_Issue_Locator_Abstract
{
    ...
    public function getIssues()
    {
        ...
        if ($outdatedMarketplaces === false) {
            ...
            Mage::helper('M2ePro/Data_Cache_Permanent')->setValue(
                self::CACHE_KEY, $outdatedMarketplaces, array('ebay','marketplace'), 60*60*24
            );
        }

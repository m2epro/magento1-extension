...
class Ess_M2ePro_Model_Upgrade_Migration_ToVersion651_Configs extends Ess_M2ePro_Model_Upgrade_Migration_Abstract
{
    ...
    private function primaryConfig()
    {
        $primaryConfig = $this->installer->getPrimaryConfigModifier();
        ...
        $this->installer->getPrimaryConfigModifier()->insert('/M2ePro/license/', 'status', 1);
    }
    ...
    private function moduleConfig()
    {
        ...
        $this->installer->getMainConfigModifier()->insert(
        ...
        $this->installer->getConnection()->delete(
            $this->installer->getTablesObject()->getFullName('config'),
        ...
        if ($this->installer->getTablesObject()->isExists('synchronization_config')) {
            ...
            $inspectorMode = $this->installer->getConnection()
                ->select()
        ...
        $this->installer->getMainConfigModifier()->getEntity('/cron/', 'last_executed_slow_task')->updateValue(NULL);
        ...
        $this->installer->getMainConfigModifier()->insert('/cron/task/ebay/order/create_failed/',
                                                          'interval', '60', 'in seconds');
        $this->installer->getMainConfigModifier()->insert(
            '/cron/task/ebay/order/update/', 'mode', '1', '0 - disable, \r\n1 - enable'
        );
        $this->installer->getMainConfigModifier()->insert('/cron/task/ebay/order/update/',
                                                          'interval', '60', 'in seconds');
        $this->installer->getMainConfigModifier()->insert(
            '/cron/task/ebay/order/cancel/', 'mode', '1', '0 - disable, \r\n1 - enable'
        );
        $this->installer->getMainConfigModifier()->insert('/cron/task/ebay/order/cancel/',
                                                          'interval', '60', 'in seconds');
        $this->installer->getMainConfigModifier()->insert(
            '/cron/task/ebay/order/reserve_cancel/', 'mode', '1', '0 - disable, \r\n1 - enable'
        );
        $this->installer->getMainConfigModifier()->insert('/cron/task/ebay/order/reserve_cancel/',
                                                          'interval', '60', 'in seconds');
        $this->installer->getMainConfigModifier()->insert(
        ...
        $this->installer->getMainConfigModifier()->insert('/listing/product/revise/total/ebay/', 'mode', '0', NULL);
        $this->installer->getMainConfigModifier()->insert(
        ...
        $this->installer->getMainConfigModifier()->insert('/ebay/listing/product/action/list/',
        ...
        $this->installer->getMainConfigModifier()->insert('/ebay/listing/product/action/stop/',
        ...
        $this->installer->getMainConfigModifier()->insert('/cron/task/amazon/order/receive/',
                                                          'interval', '60', 'in seconds');
        $this->installer->getMainConfigModifier()->insert(
            '/cron/task/amazon/order/create_failed/', 'mode', '1', '0 - disable, \r\n1 - enable'
        );
        $this->installer->getMainConfigModifier()->insert('/cron/task/amazon/order/create_failed/',
                                                          'interval', '60', 'in seconds');
        $this->installer->getMainConfigModifier()->insert(
            '/cron/task/amazon/order/update/', 'mode', '1', '0 - disable, \r\n1 - enable'
        );
        $this->installer->getMainConfigModifier()->insert('/cron/task/amazon/order/update/',
                                                          'interval', '60', 'in seconds');
        $this->installer->getMainConfigModifier()->insert(
        ...
        $this->installer->getMainConfigModifier()->insert('/cron/task/amazon/order/refund/',
                                                          'interval', '60', 'in seconds');
        $this->installer->getMainConfigModifier()->insert(
            '/cron/task/amazon/order/cancel/', 'mode', '1', '0 - disable, \r\n1 - enable'
        );
        $this->installer->getMainConfigModifier()->insert('/cron/task/amazon/order/cancel/',
                                                          'interval', '60', 'in seconds');
        $this->installer->getMainConfigModifier()->insert(
            '/cron/task/amazon/order/reserve_cancel/', 'mode', '1', '0 - disable, \r\n1 - enable'
        );
        $this->installer->getMainConfigModifier()->insert('/cron/task/amazon/order/reserve_cancel/',
                                                          'interval', '60', 'in seconds');
        $this->installer->getMainConfigModifier()->insert(
        ...
        $this->installer->getMainConfigModifier()->insert('/listing/product/revise/total/amazon/', 'mode', '0', NULL);
        $this->installer->getMainConfigModifier()->insert(
        ...
        $this->installer->getMainConfigModifier()->insert('/amazon/listing/product/action/list/',
                                                          'priority_coefficient', '25', NULL);
        $this->installer->getMainConfigModifier()->insert(
    ...
    {
        $configTable = $this->installer->getTable('m2epro_config');
        $cacheConfigTable = $this->installer->getTable('m2epro_cache_config');

        $oldData = $this->installer->getConnection()->query("
...
")->fetchAll();
        ...
        if (!empty($insertParts)) {
            ...
            $this->installer->getConnection()->query($insertSql);
...
SQL
        ...
        $this->installer->getCacheConfigModifier()

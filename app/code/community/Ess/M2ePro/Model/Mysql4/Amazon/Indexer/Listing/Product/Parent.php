...
class Ess_M2ePro_Model_Mysql4_Amazon_Indexer_Listing_Product_Parent extends Ess_M2ePro_Model_Mysql4_Component_Abstract
{
    //########################################

    public function _construct()
    {
        $this->_init('M2ePro/Amazon_Indexer_Listing_Product_Parent', 'listing_product_id');
    }

...
class Ess_M2ePro_Model_Mysql4_Ebay_Listing_Product_PickupStore
    extends Ess_M2ePro_Model_Mysql4_Abstract
{
    ...
    public function processDeletedProduct(Ess_M2ePro_Model_Listing_Product $listingProduct)
    {
        ...
        if (!empty($onlineSku)) {
            /** @var Ess_M2ePro_Model_Mysql4_Ebay_Listing_Product_PickupStore_Collection $pickupStoreCollection */

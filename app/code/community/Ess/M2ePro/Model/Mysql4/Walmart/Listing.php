...
class Ess_M2ePro_Model_Mysql4_Walmart_Listing
    extends Ess_M2ePro_Model_Mysql4_Component_Child_Abstract
{
    ...
    public function updateStatisticColumns()
    {
        ...
        $walmartListingProductTable = Mage::getResourceModel('M2ePro/Walmart_Listing_Product')->getMainTable();
        ...
        $select = $this->_getReadAdapter()
                       ...
                       ->join(
                            array('alp' => $walmartListingProductTable),
        ...
        $query = "UPDATE `{$listingTable}`
                  ...
                  WHERE `component_mode` = '".Ess_M2ePro_Helper_Component_Walmart::NICK."'";

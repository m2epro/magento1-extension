...
class Ess_M2ePro_Model_Mysql4_Setup extends Ess_M2ePro_Model_Mysql4_Abstract
{
    // ########################################
    ...
    public function initCurrentSetupObject($versionFrom, $versionTo)
    {
        ...
        /** @var Ess_M2ePro_Model_Mysql4_Setup_Collection $collection */
    ...
    private function initTable()
    {
        $this->_getWriteAdapter()->query(
            <<<SQL
CREATE TABLE IF NOT EXISTS `m2epro_setup` (

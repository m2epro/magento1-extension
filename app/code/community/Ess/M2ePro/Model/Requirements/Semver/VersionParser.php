...
use Ess_M2ePro_Model_Requirements_Semver_Constraint_EmptyConstraint as EmptyConstraint;
 ...
 */
class Ess_M2ePro_Model_Requirements_Semver_VersionParser
{
    /**
    ...
    protected function parseConstraint($constraint)
    {
        ...
        $pattern = '{^(?P<from>' . $versionRegex . ') +- +(?P<to>' . $versionRegex . ')($)}i';

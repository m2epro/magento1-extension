...
HTML;
        ...
        $help = $this->getLayout()->createBlock(
            'M2ePro/adminhtml_common_listing_product_category_summary_help'
        );
...
HTML;
        ...
        $path = 'adminhtml_common_listing_productAdd/removeSessionProductsByCategory';
        $urls['adminhtml_common_listing_productAdd/removeSessionProductsByCategory'] = $this->getUrl('*/'.$path, array(

...
class Ess_M2ePro_Block_Adminhtml_ControlPanel_Info_License_Information extends Mage_Adminhtml_Block_Widget
{
    //########################################
    ...
    public function __construct()
    {
        ...
        // ---------------------------------------
        $this->setId('controlPanelAboutLicenseInformation');
        // ---------------------------------------

        $this->setTemplate('M2ePro/controlPanel/info/license/information.phtml');
    }

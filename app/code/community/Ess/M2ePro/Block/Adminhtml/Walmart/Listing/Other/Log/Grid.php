...
class Ess_M2ePro_Block_Adminhtml_Walmart_Listing_Other_Log_Grid
    extends Ess_M2ePro_Block_Adminhtml_Listing_Other_Log_Grid
{
    //########################################
    ...
    protected function getColumnTitles()
    {
        return array(
            ...
            'identifier' => Mage::helper('M2ePro')->__('GTIN'),

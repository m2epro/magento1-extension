...
class Ess_M2ePro_Block_Adminhtml_Walmart_Template_Category_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    //########################################
    ...
    public function getRowUrl($row)
    {
        return Mage::helper('M2ePro/View')
            ->getUrl($row, 'template_category', 'edit', array('id' => $row->getData('id')));
    }

...
class Ess_M2ePro_Block_Adminhtml_Walmart_Template_Synchronization extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    //########################################
    ...
    public function __construct()
    {
        ...
        // ---------------------------------------
        $url = $this->getUrl('*/adminhtml_walmart_synchronization/index');
        ...
        $this->_addButton('add', array(
            ...
            'onclick' => 'setLocation(\'' . $this->getUrl('*/adminhtml_walmart_template_synchronization/new') . '\');',
    ...
    {
        $helpBlock = $this->getLayout()->createBlock('M2ePro/adminhtml_walmart_template_synchronization_help');

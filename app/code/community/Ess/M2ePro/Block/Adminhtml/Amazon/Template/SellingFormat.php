...
class Ess_M2ePro_Block_Adminhtml_Amazon_Template_SellingFormat extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    //########################################
    ...
    public function __construct()
    {
        ...
        $this->_addButton('add', array(
            ...
            'onclick'   => 'setLocation(\''.$this->getUrl('*/adminhtml_amazon_template_sellingFormat/new').'\');',
    ...
    {
        $helpBlock = $this->getLayout()->createBlock('M2ePro/adminhtml_amazon_template_sellingFormat_help');

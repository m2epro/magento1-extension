...
class Ess_M2ePro_Block_Adminhtml_Amazon_Configuration extends Ess_M2ePro_Block_Adminhtml_Widget_Container
{
    //########################################
    ...
    public function __construct()
    {
        ...
        // ---------------------------------------
        $this->setId('amazonConfiguration');
        // ---------------------------------------
        ...
        // ---------------------------------------
        $this->setTemplate('M2ePro/amazon/configuration.phtml');
        // ---------------------------------------
    }

...
class Ess_M2ePro_Block_Adminhtml_Amazon_Template_Description_Category_Specific_Add_Grid
...
<a href="javascript:void(0);"
   class="specific_search_result_row"
   xpath ="{$row->getData('xpath')}"
   xml_tag = {$row->getData('xml_tag')}>{$title}</a>
<br/>

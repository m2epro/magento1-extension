...
class Ess_M2ePro_Block_Adminhtml_Amazon_Template_Description_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    //########################################
...
HTML;
    ...
    {
        return $this->getUrl('*/adminhtml_amazon_template_description/grid', array('_current'=>true));
    }

    public function getRowUrl($row)
    {
        return $this->getUrl('*/adminhtml_amazon_template_description/edit', array('id' => $row->getData('id')));
    }

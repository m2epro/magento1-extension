<?php
class Ess_M2ePro_Block_Adminhtml_Amazon_Listing_Product_Add_NewAsin_ProductType_Manual_Grid
    extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $actions = array(
            array(
                ...
                'field'   => 'id',
                'onclick_action' => 'ListingGridObj.setProductTypeTemplateRowAction'
            ),
            array(
                'caption' => Mage::helper('M2ePro')->__('Reset Product Type'),
                'field'   => 'id',
                'onclick_action' => 'ListingGridObj.resetProductTypeTemplateRowAction'
            )
        );
    ...
    {
        $productTypeTemplateId = $row->getData('template_product_type_id');
...
HTML;
    ...
    protected function callbackColumnProductTypeTemplateFilterCallback($collection, $column)
    {
        ...
        if ($value) {
            $collection->addFieldToFilter('template_product_type_id', array('notnull' => null));
        } else {
            $collection->addFieldToFilter('template_product_type_id', array('null' => null));
        }
    }
...
HTML;
    ...
    protected function isNotExistProductsWithProductTypeTemplate()
    {
        ...
        $countSelect->where('elp.template_product_type_id > 0');

...
class Ess_M2ePro_Block_Adminhtml_Amazon_Listing_Variation_Product_SwitchToParentPopup
    extends Mage_Adminhtml_Block_Template
{
    ...
    public function __construct()
    {
        ...
        $this->setTemplate('M2ePro/amazon/listing/variation/product/switch_to_parent_popup.phtml');
    }

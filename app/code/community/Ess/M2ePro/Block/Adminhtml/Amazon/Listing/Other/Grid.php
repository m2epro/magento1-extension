...
class Ess_M2ePro_Block_Adminhtml_Amazon_Listing_Other_Grid
    extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        return $this->getUrl('*/adminhtml_amazon_listing_other/view', array(
            'account' => $row->getData('account_id'),
            'marketplace' => $row->getData('marketplace_id'),
            'back'=>Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_amazon_listing/index', array(

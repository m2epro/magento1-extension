...
class Ess_M2ePro_Block_Adminhtml_Amazon_Synchronization_Log extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    //########################################
    ...
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_amazon_synchronization_log';
        ...
        $helpBlock = $this->getLayout()->createBlock(
            ...
            array(
                'content' => Mage::helper('M2ePro')->__(
                    ...
                    Mage::helper("M2ePro/Module_Support")->getDocumentationUrl(null, null, "x/foIVAQ")
                ),

...
abstract class Ess_M2ePro_Block_Adminhtml_Amazon_Listing_Product_Variation extends Mage_Adminhtml_Block_Widget
{
    protected $_magentoVariationsSets         = null;
    protected $_magentoVariationsCombinations = null;

    protected $_magentoVariationsTree = null;
    ...
    public function getListingProduct()
    {
        if ($this->_listingProduct === null) {
            $this->_listingProduct = Mage::helper('M2ePro/Component')->getComponentObject(
                Ess_M2ePro_Helper_Component_Amazon::NICK, 'Listing_Product', $this->getListingProductId()
            );

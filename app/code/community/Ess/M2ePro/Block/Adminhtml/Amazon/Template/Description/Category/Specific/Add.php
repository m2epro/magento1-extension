...
class Ess_M2ePro_Block_Adminhtml_Amazon_Template_Description_Category_Specific_Add
    extends Ess_M2ePro_Block_Adminhtml_Widget_Container
{
    ...
    public function __construct()
    {
        ...
        // ---------------------------------------
        $this->setTemplate('M2ePro/amazon/template/description/category/specific/add.phtml');
        // ---------------------------------------
    }

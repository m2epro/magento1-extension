...
class Ess_M2ePro_Block_Adminhtml_Amazon_Listing_Other extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    //########################################
...
HTML;
    ...
    protected function getResetPopupHtml()
    {
        ...
        $url = $this->getUrl('*/adminhtml_amazon_listing_other/reset');
...
<div id="reset_other_listings_popup_content" style="display: none">
    <div style="margin: 10px;">
        ...
        <p>{$helper->__('This action will remove all the items from Amazon 3rd Party Listings.

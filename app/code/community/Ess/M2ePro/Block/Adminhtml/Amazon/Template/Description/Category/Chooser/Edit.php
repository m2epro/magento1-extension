...
class Ess_M2ePro_Block_Adminhtml_Amazon_Template_Description_Category_Chooser_Edit
    extends Ess_M2ePro_Block_Adminhtml_Widget_Container
{
    ...
    public function __construct()
    {
        ...
        // ---------------------------------------
        $this->setTemplate('M2ePro/amazon/template/description/category/chooser/edit.phtml');
        // ---------------------------------------
    }
...
HTML;
        ...
        /** @var Ess_M2ePro_Block_Adminhtml_Amazon_Template_Description_Category_Chooser_Tabs $tabsBlock */
        $blockName = 'M2ePro/adminhtml_amazon_template_description_category_chooser_tabs';

    ...
    protected function _beforeToHtml()
    {
        ...
        $this->addTab('general', array(
            ...
            'content' => $this->getLayout()
                              ->createBlock('M2ePro/adminhtml_amazon_account_edit_tabs_general')->toHtml(),
        ));
        ...
        $this->addTab('orders', array(
            ...
            'content' => $this->getLayout()
                              ->createBlock('M2ePro/adminhtml_amazon_account_edit_tabs_order')->toHtml(),
        ));
        ...
        if (Mage::helper('M2ePro/Component_Amazon_Repricing')->isEnabled() && $account->getId()) {
            $this->addTab('repricing', array(
                ...
                'content' => $this->getLayout()
                    ->createBlock('M2ePro/adminhtml_amazon_account_edit_tabs_repricing')->toHtml(),
            ));
        }

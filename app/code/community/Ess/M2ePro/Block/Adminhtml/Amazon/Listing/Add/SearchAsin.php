...
class Ess_M2ePro_Block_Adminhtml_Amazon_Listing_Add_SearchAsin
    extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_amazon_listing_add_searchAsin';
        // ---------------------------------------
    ...
    public function getGridHtml()
    {
        ...
        $helpBlock = $this->getLayout()->createBlock('M2ePro/adminhtml_amazon_listing_add_searchAsin_help');
...
<script type="text/javascript">
    ...
    Event.observe(window, 'load', function() {
        ...
        ListingGridHandlerObj = new AmazonListingSearchAsinGridHandler(

    ...
    extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    public function __construct()
    {
        ...
        $this->setTemplate('M2ePro/amazon/listing/add/search_asin/search_settings.phtml');
    }
    ...
    {
        $child = $this->getLayout()->createBlock('M2ePro/adminhtml_amazon_listing_add_tabs_search');

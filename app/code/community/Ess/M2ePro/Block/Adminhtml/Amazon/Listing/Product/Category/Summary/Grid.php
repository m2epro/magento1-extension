...
class Ess_M2ePro_Block_Adminhtml_Amazon_Listing_Product_Category_Summary_Grid
    extends Ess_M2ePro_Block_Adminhtml_Category_Grid
{
    ...
    public function __construct()
    {
        ...
        // ---------------------------------------
        $this->setId('amazonListingProductSourceCategoriesSummaryGrid');
        // ---------------------------------------
...
HTML;
        ...
        $help = $this->getLayout()->createBlock(
            'M2ePro/adminhtml_amazon_listing_product_category_summary_help'
        );
...
HTML;
        ...
        $path = 'adminhtml_amazon_listing_productAdd/removeSessionProductsByCategory';
        $urls['adminhtml_amazon_listing_productAdd/removeSessionProductsByCategory'] = $this->getUrl('*/'.$path);
...
<script type="text/javascript">
    ...
    ProductSourceCategoriesSummaryGridHandlerObj = new AmazonListingSummaryGridHandler(
        '{$this->getId()}'
    );
</script>
HTML;

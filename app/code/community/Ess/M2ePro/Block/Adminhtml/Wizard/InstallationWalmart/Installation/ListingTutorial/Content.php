...
class Ess_M2ePro_Block_Adminhtml_Wizard_InstallationWalmart_Installation_ListingTutorial_Content
    extends Mage_Adminhtml_Block_Template
{
    ...
    {
        parent::__construct();
        $this->setId('wizardInstallationWalmartListingTutorial');
    }
...
<div class="wizard_block">
    ...
    <p>
        ...
        <br/> 
        These are the Products which will be offered as Walmart Items by a Seller on a particular Marketplace.
    </p>

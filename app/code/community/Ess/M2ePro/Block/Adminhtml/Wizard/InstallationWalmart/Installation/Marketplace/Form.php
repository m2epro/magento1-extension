...
class Ess_M2ePro_Block_Adminhtml_Wizard_InstallationWalmart_Installation_Marketplace_Form
    extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    public function __construct()
    {
        ...
        // ---------------------------------------
        $this->setId('wizardWalmartMarketplaceForm');
        $this->setContainerId('wizard_marketplaces_container');
        $this->setTemplate('M2ePro/wizard/installationWalmart/installation/marketplace/form.phtml');
        // ---------------------------------------
    }

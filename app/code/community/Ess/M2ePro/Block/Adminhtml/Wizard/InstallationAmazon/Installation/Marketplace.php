...
class Ess_M2ePro_Block_Adminhtml_Wizard_InstallationAmazon_Installation_Marketplace
    extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        $this->setTemplate('M2ePro/wizard/installationAmazon/installation/marketplace.phtml');
    }
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->setChild(
            ...
            $this->getLayout()->createBlock('M2ePro/adminhtml_wizard_installationAmazon_installation_marketplace_form')
        );

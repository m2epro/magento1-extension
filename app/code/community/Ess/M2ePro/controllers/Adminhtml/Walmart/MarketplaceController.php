...
{
    const SYNCHRONIZATION_LOCK_ITEM_NICK = 'walmart_marketplace_synchronization';
        ...
        $this->_initAction()
            ->_addContent(
                $this->getLayout()->createBlock(
                    ...
                    array('active_tab' => Ess_M2ePro_Block_Adminhtml_Walmart_Configuration_Tabs::TAB_ID_MARKETPLACE)
                )
            )->renderLayout();
    }

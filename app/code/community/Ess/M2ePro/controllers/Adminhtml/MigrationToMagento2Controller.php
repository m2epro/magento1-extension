    ...
    extends Ess_M2ePro_Controller_Adminhtml_BaseController
{
    ...
    private function initialize()
    {
        ...
        Mage::helper('M2ePro/Primary')->getConfig()->setGroupValue(
            '/migrationtomagento2/source/', 'version', self::MIGRATION_VERSION
        );
        Mage::helper('M2ePro/Primary')->getConfig()->setGroupValue(
    ...
    private function backupTables()
    {
        ...
        $backupObject = Mage::getModel('M2ePro/Upgrade_Backup', array(
    ...
    private function createMagentoMap()
    {
        /** @var Varien_Db_Adapter_Interface $connection */
        ...
        /** @var Ess_M2ePro_Model_Mysql4_Listing_Auto_Category_Collection $autoCategoryCollection */
